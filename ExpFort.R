...
Y1$B=c(3,4)
lines(Y$A,Y$RP,lw=2)
lines(Y1$B,Y1$RP,col='red',lw=2)

text(1,23,"-1.0", cex=0.5)
text(2,23,"1.0", cex=0.5)
text(3,14,"-1.0", cex=0.5)
text(4,27,"1.0", cex=0.5)
j<-(Factorial2.k %>% group_by(A,B) %>% summarise(P=mean(RP)))
plot(NA,xlim=c(1,2),xlab=("A:Bebida"), ylim=c(10,30), ylab=("Puntaje"))
for (a in split(j,j$B)) {
  lines(a$A,a$P,col=a$B[1],lw=2)
  
}
text(1.5,30,"B:Habilidad = +", cex=0.7)

text(1.5,16,"B:Habilidad = -",cex= 0.7)
text(1.1,16,"A = -",cex= 0.7)
text(1.9,16,"A = +",cex= 0.7)
text(1.1,30,"A = -",cex= 0.7)
text(1.9,30,"A = +",cex= 0.7)
...
Y3$B=c(3,4)
lines(Y2$A,Y2$RR,lw=2)
lines(Y3$B,Y3$RR,col='red',lw=2)

text(1,24,"-1.0", cex=0.5)
text(2,23,"1.0", cex=0.5)
text(3,18,"-1.0", cex=0.5)
text(4,28,"1.0", cex=0.5)
...
text(1.5,31,"B:Habilidad = +", cex=0.7)

text(1.5,18,"B:Habilidad = -",cex= 0.7)
text(1.1,18,"A = -",cex= 0.7)
text(1.9,18,"A = +",cex= 0.7)
text(1.1,31,"A = -",cex= 0.7)
text(1.9,31,"A = +",cex= 0.7)